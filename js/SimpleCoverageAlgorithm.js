var simpleCoverageAlgorithm = {
  ...
  checkRight: function(nodes, view){
    if (1 - nodes[nodes.length - 1].x > radius) {
      ...
      setTimeout(function() {
        this.moveLeft(nodes, nodes.length - 2, view);
      }, view.delay);
